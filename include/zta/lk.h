...
namespace lk
{
  ...
  namespace impl
  {
    ...
    [[noreturn]] inline void not_implemented(const char *msg)
    {
...
namespace lk
{
  inline Z make_bignum(long)
  {
    impl::not_implemented("make_bignum");
  }

  inline Z make_string(const char *)
  {
    impl::not_implemented("make_string");
  }
